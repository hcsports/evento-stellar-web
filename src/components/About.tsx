      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto mb-12 text-center">
          ...
          <p className="text-gray-600">
            Há mais de 10 anos transformando ideias em experiências inesquecíveis
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="animate-on-scroll mb-8">
              ...
              <p className="mb-6 text-gray-700">
                Somos uma empresa especializada na produção de eventos corporativos, sociais e culturais, 
                com foco na excelência e atenção aos detalhes. Nossa equipe conta com profissionais 
                experientes em diversas áreas, garantindo que seu evento seja um sucesso do início ao fim.
              </p>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="animate-on-scroll bg-white p-6 rounded-lg shadow-sm border border-gray-100 delay-300">
                ...
                <h4 className="text-xl font-semibold mb-2">+200</h4>
          ...
          <div className="relative animate-on-scroll">
            <div className="rounded-lg overflow-hidden shadow-xl">
              <img 
                src="https://images.unsplash.com/photo-1540575467063-178a50c2df87?auto=format&fit=crop&q=80&w=1470" 
                alt="Equipe de produção de eventos trabalhando" 
                className="w-full h-auto"
              />
            </div>
            <div className="absolute -bottom-8 -right-8 bg-primary text-white p-6 rounded-lg shadow-lg md:max-w-xs hidden md:block">
              <h4 className="text-xl font-semibold mb-2">Nosso diferencial</h4>
              <p>
                Combinamos criatividade, organização e tecnologia para entregar eventos memoráveis e sem preocupações para nossos clientes.
              </p>
            </div>
          </div>
        </div>
