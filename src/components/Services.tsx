      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto mb-16 text-center">
          ...
          <p className="text-gray-600">
            Oferecemos soluções completas para diversos tipos de eventos, cuidando de todos os detalhes para que você não precise se preocupar.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {ServicesData.map((service, index) => (
            <div 
              key={index}
              className="animate-on-scroll service-card bg-white p-6 rounded-lg shadow-md border border-gray-100 text-center"
